...
interface OrderClaimItemImageModel
  extends DmlEntity<
    DMLEntitySchemaBuilder<(typeof _OrderClaimItemImage)["schema"]>,
    "OrderClaimItemImage"
  > {}

export const OrderClaimItemImage: OrderClaimItemImageModel =
  _OrderClaimItemImage
