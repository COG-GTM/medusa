...
interface OrderExchangeItemModel
  extends DmlEntity<
    DMLEntitySchemaBuilder<(typeof _OrderExchangeItem)["schema"]>,
    "OrderExchangeItem"
  > {}

export const OrderExchangeItem: OrderExchangeItemModel = _OrderExchangeItem
